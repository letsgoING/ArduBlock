...
public class AnalogGetSwitch1Block extends TranslatorBlock
{
	public AnalogGetSwitch1Block(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = "Button1.getSwitchDebounced()";
