...
public class AnalogGetSwitch2Block extends TranslatorBlock
{
	public AnalogGetSwitch2Block(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		String ret = "Button2.getSwitchDebounced()";
