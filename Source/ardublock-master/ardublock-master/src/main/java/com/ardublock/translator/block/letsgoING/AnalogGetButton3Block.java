...
public class AnalogGetButton3Block extends TranslatorBlock
{
	public AnalogGetButton3Block(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
