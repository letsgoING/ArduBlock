...
public class AndroidRemoteBlockMon extends TranslatorBlock
{
	public AndroidRemoteBlockMon(Long blockId, Translator translator, String codePrefix,	String codeSuffix, String label)
	{
