...
public class DriveBlock extends TranslatorBlock
{

  public DriveBlock (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
  {
  ...
  public String toCode() throws SocketNullException, SubroutineNotDeclaredException
  {
	...
	ret = "Rover.drive(" +speed + "," +direction + ");\n";
